...
3. Check `02-provenance/traceability-matrix.md` for orphaned requirements or unverified components.
4. Check `02-provenance/contradictions.md` to ensure all conflicts have been arbitrated via an ADR.
5. Output a comprehensive audit scorecard (Coverage %, Discrepancies, and Action Items).
